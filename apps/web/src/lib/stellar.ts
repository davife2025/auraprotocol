/**
 * Stellar wallet integration using the Freighter browser extension.
...
/** Connect Freighter and return public key */
...
/** Build a sign-in message for Stellar wallet auth */
